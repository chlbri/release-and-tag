...
var require_webidl = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  webidl.converters.ArrayBuffer = function (V, prefix, argument, opts) {
    if (webidl.util.Type(V) !== "Object" || !types$3.isAnyArrayBuffer(V))
  ...
  webidl.converters.DataView = function (V, prefix, name, opts) {
    if (webidl.util.Type(V) !== "Object" || !types$3.isDataView(V))
      throw webidl.errors.exception({
        header: prefix,
...
var require_response = /* @__PURE__ */ __commonJSMin((exports, module) => {
  ...
  webidl.converters.XMLHttpRequestBodyInit = function (V, prefix, name) {
    ...
    if (ArrayBuffer.isView(V) || types$2.isArrayBuffer(V))
            ...
            onHeaders(status, rawHeaders, resume, statusText) {
              ...
              resolve({
                ...
                body: decoders.length
                  ? pipeline$1(this.body, ...decoders, (err) => {
...
function omit(object, keysToOmit) {
  ...
  for (const key of Object.keys(object))
    if (keysToOmit.indexOf(key) === -1) result[key] = object[key];
  return result;
}
  ...
  if (!/application\/octet-stream/i.test(headers.accept)) {
    ...
    if (url.endsWith("/graphql")) {
      if (options.mediaType.previews?.length)
        headers.accept = (headers.accept.match(/(?<![\w-])[\w-]+(?=-preview)/g) || [])
...
const JSONStringify = (value, replacer, space) => {
  ...
  return originalStringify(
    ...
    .replace(bigIntsStringify, "$1$2$3")
    .replace(noiseStringify, "$1$2$3");
};
...
const JSONParse = (text, reviver) => {
  ...
  return originalParse(
    text.replace(stringsOrLargeNumbers, (text, digits, fractional, exponential) => {
      const isString = text[0] === '"';
      if (isString && noiseValueWithQuotes.test(text))
...
var defaults_default = {
  headers: { "user-agent": `octokit-request.js/10.0.10 ${getUserAgent()}` },
};
  ...
  if (options) {
    if (typeof query === "string" && "query" in options)
      return Promise.reject(
        /* @__PURE__ */ new Error(`[@octokit/graphql] "query" cannot be used as variable name`),
      );
    for (const key in options) {
      if (!FORBIDDEN_VARIABLE_OPTIONS.includes(key)) continue;
      return Promise.reject(
        /* @__PURE__ */ new Error(`[@octokit/graphql] "${key}" cannot be used as variable name`),
      );
    }
  }
      ...
      async next() {
        ...
        try {
          ...
          if (!url && "total_commits" in normalizedResponse.data) {
            ...
            if (
              page * parseInt(params.get("per_page") || "250", 10) <
              normalizedResponse.data.total_commits
            ) {
...
//#endregion
//#region src/create-release.ts
async function run() {
  try {
    const github = getOctokit(process.env.GITHUB_TOKEN || "");
    const { owner, repo } = context.repo;
    const tag = getInput("tag_name", { required: true }).replace("refs/tags/", "");
    const releaseName = getInput("release_name", { required: true }).replace("refs/tags/", "");
